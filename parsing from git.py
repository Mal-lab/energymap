...
list_of_refs = get_refs(7, 'https://energybase.ru/power-plant/index?PowerPlantSearch%5Bcountry_id%5D=&PowerPlantSearch%5Bdistrict_id%5D=29&PowerPlantSearch%5Bname%5D=&PowerPlantSearch%5Btype_name%5D=&PowerPlantSearch%5Bcity_id%5D=&PowerPlantSearch%5Bstate%5D=&page=7')
k = 0
data = {}
for ref in list_of_refs:
  ...
  exporting_data.to_excel('gen_data.xlsx')